...
const Navhome = () => {
  ...
  return (
    <div>
      <div className="relative z-0 bg-gray lag:w-[100vw] lag:h-[73px] h-[73px] w-[100vw] overflow-hidden text-center text-base text-white font-audiowide">
        <ul
          className="m-0 hidden lag:flex justify-evenly items-center absolute top-[20px] left-[280px] w-[800px] h-[38px]"
          id="list"
          list="none"
        >
          {/* m-0 hidden lag:flex justify-evenly items-center absolute top-[55px] left-[453px] w-[555px] h-[38px]  */}
        ...
        <div className="absolute top-[60px] left-[calc(50%_-_1015px)] w-[2030px] h-[26px]">
          <img
